...
\PY{n}{def\PYZus{}style} \PY{o}{=} \PY{l+s}{\PYZsq{}}\PY{l+s}{ggplot}\PY{l+s}{\PYZsq{}}
...
\PY{c}{\PYZsh{}\PYZsh{} set up latex output}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{pgf\PYZus{}with\PYZus{}latex} \PY{o}{=} \PY{p}{\PYZob{}}                      \PY{c}{\PYZsh{} setup matplotlib to use latex for output}
        \PY{l+s}{\PYZdq{}}\PY{l+s}{pgf.texsystem}\PY{l+s}{\PYZdq{}}\PY{p}{:} \PY{l+s}{\PYZdq{}}\PY{l+s}{pdflatex}\PY{l+s}{\PYZdq{}}\PY{p}{,}        \PY{c}{\PYZsh{} change this if using xetex or lautex}
        \PY{l+s}{\PYZdq{}}\PY{l+s}{text.usetex}\PY{l+s}{\PYZdq{}}\PY{p}{:} \PY{n+nb+bp}{True}\PY{p}{,}                \PY{c}{\PYZsh{} use LaTeX to write all text}
        ...
        \PY{l+s}{\PYZdq{}}\PY{l+s}{axes.labelsize}\PY{l+s}{\PYZdq{}}\PY{p}{:} \PY{l+m+mi}{10}\PY{p}{,}               \PY{c}{\PYZsh{} LaTeX default is 10pt font.}
        \PY{l+s}{\PYZdq{}}\PY{l+s}{text.fontsize}\PY{l+s}{\PYZdq{}}\PY{p}{:} \PY{l+m+mi}{10}\PY{p}{,}
        \PY{l+s}{\PYZdq{}}\PY{l+s}{legend.fontsize}\PY{l+s}{\PYZdq{}}\PY{p}{:} \PY{l+m+mi}{8}\PY{p}{,}               \PY{c}{\PYZsh{} Make the legend/label fonts a little smaller}
...
\PY{c}{\PYZsh{}     plt.savefig(\PYZsq{}\PYZob{}\PYZcb{}.pdf\PYZsq{}.format(filename))}
\PY{c}{\PYZsh{}     plt.savefig(\PYZsq{}\PYZob{}\PYZcb{}.eps\PYZsq{}.format(filename))}
\end{Verbatim}
...
\PY{n}{data\PYZus{}damped\PYZus{}motion} \PY{o}{=} \PY{p}{\PYZob{}}\PY{n}{k}\PY{p}{:}\PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{DM}\PY{l+s}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{k}\PY{p}{)} \PY{o}{+} \PY{l+s}{\PYZdq{}}\PY{l+s}{.csv}\PY{l+s}{\PYZdq{}}\PY{p}{)} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{4}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{]}\PY{p}{\PYZcb{}}
...
\subsection{Part I: Calculation of spring
...
\PY{n}{X\PYZus{}rw} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{data\PYZus{}spring\PYZus{}coeff}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{P M}\PY{l+s}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{k}\PY{p}{)}\PY{p}{]} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\PY{n}{F\PYZus{}rw} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{n}{data\PYZus{}spring\PYZus{}coeff}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{F M}\PY{l+s}{\PYZsq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{k}\PY{p}{)}\PY{p}{]} \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{]}\PY{p}{)}

\PY{c}{\PYZsh{} calculate the mean value and related uncertainties (standard deviation)}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.figure.Figure at 0x7f6c99e64190>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{main_analysis_files/main_analysis_6_1.png}
    \par
    \end{center}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{errorbar}\PY{p}{(}\PY{p}{[}\PY{n}{x}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{X}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{f}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{k}{for} \PY{n}{f} \PY{o+ow}{in} \PY{n}{F}\PY{p}{]}\PY{p}{,}
             \PY{n}{xerr}\PY{o}{=}\PY{p}{[}\PY{n}{x}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n}{X}\PY{p}{]}\PY{p}{,} \PY{n}{yerr}\PY{o}{=}\PY{p}{[}\PY{n}{f}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]} \PY{k}{for} \PY{n}{f} \PY{o+ow}{in} \PY{n}{F}\PY{p}{]}\PY{p}{,}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.figure.Figure at 0x7f6c99c77350>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{main_analysis_files/main_analysis_7_1.png}
    \par
    \end{center}
...
\PY{n}{m\PYZus{}1} \PY{o}{=} \PY{n}{get\PYZus{}slope}\PY{p}{(}\PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{X}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{F}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\PY{n}{b\PYZus{}1} \PY{o}{=} \PY{n}{get\PYZus{}intercept}\PY{p}{(}\PY{n}{m\PYZus{}1}\PY{p}{,} \PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\PY{n}{m\PYZus{}2} \PY{o}{=} \PY{n}{get\PYZus{}slope}\PY{p}{(}\PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{X}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{F}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\PY{n}{b\PYZus{}2} \PY{o}{=} \PY{n}{get\PYZus{}intercept}\PY{p}{(}\PY{n}{m\PYZus{}2}\PY{p}{,} \PY{p}{(}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{X}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{+}\PY{n}{F}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}

\PY{c}{\PYZsh{} print \PYZdq{}Points:\PYZbs{}nP1: (\PYZob{}\PYZcb{}, \PYZob{}\PYZcb{})\PYZdq{}.format(X[0][0]\PYZhy{}X[0][1], F[0][0]+F[0][1])}
\PY{c}{\PYZsh{} print \PYZdq{}P2: (\PYZob{}\PYZcb{}, \PYZob{}\PYZcb{})\PYZdq{}.format(X[\PYZhy{}1][0]+X[\PYZhy{}1][1], F[\PYZhy{}1][0]\PYZhy{}F[\PYZhy{}1][1])}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xs}\PY{p}{,} \PY{n}{m}\PY{o}{*}\PY{n}{xs}\PY{o}{+}\PY{n}{b}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{b\PYZhy{}\PYZhy{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xs}\PY{p}{,} \PY{n}{m\PYZus{}1}\PY{o}{*}\PY{n}{xs}\PY{o}{+}\PY{n}{b\PYZus{}1}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{g\PYZhy{}\PYZhy{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{xs}\PY{p}{,} \PY{n}{m\PYZus{}2}\PY{o}{*}\PY{n}{xs}\PY{o}{+}\PY{n}{b\PYZus{}2}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{g\PYZhy{}\PYZhy{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.figure.Figure at 0x7f6c99633cd0>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{main_analysis_files/main_analysis_9_1.png}
    \par
    \end{center}
...
\PY{k}{def} \PY{n+nf}{ex\PYZus{}damped\PYZus{}shm}\PY{p}{(}\PY{n}{A}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{b}\PY{p}{,} \PY{n}{k}\PY{p}{,} \PY{n}{ph} \PY{o}{=} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{:}
    \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{50}\PY{p}{,} \PY{l+m+mi}{5000}\PY{p}{)}
    ...
    \PY{k}{for} \PY{n}{T} \PY{o+ow}{in} \PY{n}{t}\PY{p}{:}
        \PY{n}{x}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{A}\PY{o}{*}\PY{p}{(}\PY{n}{math}\PY{o}{.}\PY{n}{e}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{o}{*}\PY{n}{T}\PY{o}{*}\PY{n+nb}{float}\PY{p}{(}\PY{n}{b}\PY{p}{)}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{m}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{n}{math}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{omega\PYZus{}prime}\PY{o}{*}\PY{n}{T} \PY{o}{+} \PY{n}{ph}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
\PY{c}{\PYZsh{}     plt.plot(t, [0*i for i in range(len(t))], linewidth=2.0)}
    ...
    \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{n}{x\PYZus{}e}\PY{p}{,} \PY{n}{label}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Env.}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{linewidth}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
...
\end{Verbatim}
        ...
        \needspace{4\baselineskip}
            ...
            % Add document contents.
                ...
                \begin{InvisibleVerbatim}
                \vspace{-0.5\baselineskip}
\begin{alltt}<matplotlib.figure.Figure at 0x7f6c9975a210>\end{alltt}
            ...
            \end{InvisibleVerbatim}
                ...
                \vspace{-0.5\baselineskip}
    \begin{center}
    \includegraphics[max size={\textwidth}{\textheight}]{main_analysis_files/main_analysis_12_1.png}
    \par
    \end{center}
    ...
    \needspace{4\baselineskip}
        ...
        \begin{ColorVerbatim}
            \vspace{-0.7\baselineskip}
            \begin{Verbatim}[commandchars=\\\{\}]
\PY{c}{\PYZsh{} dm5 = data\PYZus{}damped\PYZus{}motion[5]}
\PY{c}{\PYZsh{} dm5 = dm5[(np.abs(stats.zscore(dm5)) \PYZlt{} 10).all(axis=1)]}
\PY{n}{M5P1} \PY{o}{=} \PY{n}{dm5}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{M5 P1}\PY{l+s}{\PYZsq{}}\PY{p}{]}
\PY{c}{\PYZsh{} M5P2 = dm5[\PYZsq{}M5 P2\PYZsq{}]}
\PY{c}{\PYZsh{} M5P3 = dm5[\PYZsq{}M5 P3\PYZsq{}]}
\PY{c}{\PYZsh{} M5P4 = dm5[\PYZsq{}M5 P4\PYZsq{}]}
\PY{c}{\PYZsh{} M5P5 = dm5[\PYZsq{}M5 P5\PYZsq{}]}
\PY{c}{\PYZsh{} M5T = dm5[\PYZsq{}T\PYZsq{}]}
\PY{c}{\PYZsh{} plt.figure(figsize=(12, 5))}
\PY{c}{\PYZsh{} \PYZsh{} plt.plot(M5P2[:25*2], M5V2[:25*2])}
\PY{c}{\PYZsh{} plt.xlim([0, 150])}
\PY{c}{\PYZsh{} \PYZsh{} plt.ylim([\PYZhy{}0.15, 0.15])}
\PY{c}{\PYZsh{} k = (M5P1.mean() + M5P2.mean() + M5P3.mean() + M5P4.mean() + M5P5.mean())/5.0}
\PY{c}{\PYZsh{} \PYZsh{} print k}
\PY{c}{\PYZsh{} plt.plot(M5T, M5P1\PYZhy{}k)}
\PY{c}{\PYZsh{} plt.plot(M5T, M5P2\PYZhy{}k)}
\PY{c}{\PYZsh{} plt.plot(M5T, M5P3\PYZhy{}k)}
\PY{c}{\PYZsh{} plt.plot(M5T, M5P4\PYZhy{}k)}
\PY{c}{\PYZsh{} plt.plot(M5T, M5P5\PYZhy{}k)}
\PY{c}{\PYZsh{} \PYZsh{} plt.plot(M5T, M5P)}
\PY{c}{\PYZsh{} \PYZsh{} plt.legend()}
\end{Verbatim}
